<?php
    ...
    if(isset($_SESSION['admin_login'])) {
        if($_SESSION['admin_login'] == true) {
            // Select last 5 retailers with zone and sector information
            $query_selectRetailer = "
                SELECT 
                    retailer.username, 
                    area.area_code, 
                    zone.zone_name, 
                    ...
                    retailer.address 
                FROM retailer 
                INNER JOIN area ON retailer.area_id = area.area_id 
                LEFT JOIN zone ON area.zone_id = zone.zone_id 
                LEFT JOIN sector ON area.sector_id = sector.sector_id 
                ORDER BY retailer.retailer_id DESC 
                LIMIT 5";
            ...
            $query_selectProducts = "
                ...
                INNER JOIN unit ON products.unit = unit.id 
        ...
        <article>
            ...
            <table class="table_displayData">
                ...
                <tr>
                    ...
                    <!--<td> <//?php echo $row_selectRetailer['zone_name']; ?> </td>
                    <td> <//?php echo $row_selectRetailer['sector_name']; ?> </td>-->
