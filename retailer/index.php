...
if (isset($_SESSION['retailer_login'])) {
    if ($_SESSION['retailer_login'] == true) {
        ...
        $query_selectRetailer = "
            ...
            JOIN 
                sector s ON r.sector_id = s.sector_id 
            WHERE 
                r.retailer_id = '$id'
        ";
        $result_selectRetailer = mysqli_query($con, $query_selectRetailer);

        if ($row_selectRetailer = mysqli_fetch_array($result_selectRetailer)) {
            $_SESSION['sessUsername'] = $row_selectRetailer['username'];
        } else {
            echo "No retailer information found for the given ID.";
            exit;
        }
        ...
        <article>
            ...
            <table class="table_displayData">
                ...
                <tr>
                    ...
                    <td> <?php echo $row_selectRetailer['area_name']; ?> </td>
