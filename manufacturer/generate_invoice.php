...
<body>
    ...
    <section>
        ...
        <tr>
            <td> Invoice No: </td>
            <td> <?php echo ($row_selectInvoiceId && isset($row_selectInvoiceId['AUTO_INCREMENT'])) ? $row_selectInvoiceId['AUTO_INCREMENT'] : ''; ?> </td>
        </tr>
        <tr>
            <td> Invoice Date: </td>
        ...
        <tr>
            <td> Order Date: </td>
            <td> <?php echo ($row_selectOrder ? date("d-m-Y", strtotime($row_selectOrder['date'])) : ''); ?> </td>
        </tr>
        </table>
        ...
        <table class="table_invoiceFormat">
            ...
            <?php while($row_selectOrderItems = mysqli_fetch_array($result_selectOrderItems)) { ?>
            <tr>
